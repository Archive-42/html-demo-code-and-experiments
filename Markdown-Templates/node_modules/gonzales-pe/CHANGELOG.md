...
:green\_apple: Fixed parsing of unicode ranges.
...
:green\_apple: Fixed the issue when selectors inside extends were not wrapped in `selector` nodes in Sass and SCSS.  
