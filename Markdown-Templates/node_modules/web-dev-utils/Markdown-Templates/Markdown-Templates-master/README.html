...
<p><!-- SHIELDS --> <!-- For how-to notes on shield badges, see docs: https://shields.io/ --></p>
<figure>
<img src="https://avatars.githubusercontent.com/u/66654881?s=460&amp;u=fa9d2cc45bc228dd9b7d3dee6d4653f940fab35a&amp;v=4" alt="logo" /><figcaption>logo</figcaption>
</figure>
<p># Title ## Subtitle</p>
<p><!-- TOC --> <strong>TOC</strong><br />
...
<p><!-- SUMMARY --> A 1-5 sentence summary of what the app is.<br />
...
<p><!-- SPLASHY IMAGE --> <img 
    ...
    title="" 
    width="100%"></p>
<p><!-- WEBSITE LINK --> ##Try the Demo! <a href="">[Live Website]</a> <!-- OPTIONAL Use an image button for extra fancy points. --> <!-- <a href=""><img src="" alt="Button image to go to app site" title="Click to see the live site!"></a> --></p>
</div>
<hr />
<p><a href="#-"><img src="https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/colored.png" alt="—————————————————–" /></a></p>
<!-- ABOUT -->
...
<p>##Get started on Heroku - Account, Database, Config Vars 1. Install the <a href="https://devcenter.heroku.com/articles/heroku-cli">Heroku CLI</a>, if you haven’t done so already. 2. Create a <a href="https://signup.heroku.com/dc">free Heroku account</a>. 3. Login and <a href="https://dashboard.heroku.com/new-app">create a new Heroku app</a>. 4. Navigate to the <em>Resources</em> tab an set up a ‘Heroku Postgres’ database for the app. 5. Select the ‘Hobby Dev - Free’ plan. 6. Navigate to the <em>Settings</em> tab. Click ‘Reveal Config Vars’. Set the environment variables needed to run the app. - <strong>NOTE</strong> NEVER check in <code>.env</code> files or any private keys. Environment variables set in an <code>.env</code> file won’t work in Heroku anyway. - <strong>NOTE</strong> See the <code>DATABASE_URL</code> is already set. This is done when the Heroku Postgres database was set up. Therefore, <code>DB_USERNAME</code>, <code>DB_PASSWORD</code>, and <code>DB_DATABASE</code> arent’ required.</p>
<p>##Configure the app to use the Heroku Postgres database There are two ways to configure the <code>production</code> environment: 1. With <em>dotenv</em> and a <code>.sequelizerc</code> file that points to a <code>config/database.js</code> file. 2. The Sequelize CLI’s auto-generated <code>config.json</code> file.</p>
<p><strong>With .sequelizerc and dotenv</strong> Update the <code>config/database.js</code> file with a <code>production</code> key like so.</p>
<div class="sourceCode" id="cb1"><pre class="sourceCode js"><code class="sourceCode javascript"><a class="sourceLine" id="cb1-1" title="1"><span class="co">// config/database.js</span></a>
...
<a class="sourceLine" id="cb1-4" title="4">  <span class="dt">development</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb1-5" title="5">    <span class="co">// ...</span></a>
<a class="sourceLine" id="cb1-6" title="6">  <span class="op">},</span></a>
<a class="sourceLine" id="cb1-7" title="7">  <span class="dt">production</span><span class="op">:</span> <span class="op">{</span></a>
<a class="sourceLine" id="cb1-8" title="8">    <span class="dt">use_env_variable</span><span class="op">:</span> <span class="st">&#39;DATABASE_URL&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb1-9" title="9">    <span class="dt">dialect</span><span class="op">:</span> <span class="st">&#39;postgres&#39;</span><span class="op">,</span></a>
<a class="sourceLine" id="cb1-10" title="10">    <span class="dt">dialectOptions</span><span class="op">:</span> <span class="op">{</span><span class="dt">ssl</span><span class="op">:</span> <span class="kw">true</span><span class="op">},</span></a>
<a class="sourceLine" id="cb1-11" title="11">    <span class="dt">seederStorage</span><span class="op">:</span> <span class="st">&#39;sequelize&#39;</span><span class="op">,</span></a>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode json"><code class="sourceCode json"><a class="sourceLine" id="cb2-1" title="1"><span class="er">&quot;production&quot;:</span> <span class="fu">{</span></a>
<a class="sourceLine" id="cb2-2" title="2">  <span class="dt">&quot;dialect&quot;</span><span class="fu">:</span> <span class="st">&quot;postgres&quot;</span><span class="fu">,</span></a>
<a class="sourceLine" id="cb2-3" title="3">  <span class="dt">&quot;seederStorage&quot;</span><span class="fu">:</span> <span class="st">&quot;sequelize&quot;</span><span class="fu">,</span></a>
<a class="sourceLine" id="cb2-4" title="4">  <span class="dt">&quot;use_env_variable&quot;</span><span class="fu">:</span> <span class="st">&quot;DATABASE_URL&quot;</span></a>
...
<a class="sourceLine" id="cb3-3" title="3"><span class="ex">remote</span>: -----<span class="op">&gt;</span> Launching...</a>
<a class="sourceLine" id="cb3-4" title="4"><span class="ex">remote</span>:        Released v5</a>
<a class="sourceLine" id="cb3-5" title="5"><span class="ex">remote</span>:        https://«your-app-name».herokuapp.com/ deployed to Heroku</a>
<a class="sourceLine" id="cb3-6" title="6"><span class="ex">remote</span>:</a>
<a class="sourceLine" id="cb3-7" title="7"><span class="ex">remote</span>: Verifying deploy... done.</a>
<a class="sourceLine" id="cb3-8" title="8"><span class="ex">To</span> https://git.heroku.com/«app-name-here».git</a></code></pre></div>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb4-1" title="1"><span class="ex">heroku</span> run npx sequelize-cli db:migrate</a></code></pre></div>
<ol start="2" type="1">
<li>To seed, preface the seed command with <code>heroku run</code> as well.</li>
</ol>
<div class="sourceCode" id="cb5"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb5-1" title="1"><span class="ex">heroku</span> run npx sequelize-cli db:seed:all</a></code></pre></div>
<ol start="3" type="1">
...
<div class="sourceCode" id="cb6"><pre class="sourceCode bash"><code class="sourceCode bash"><a class="sourceLine" id="cb6-1" title="1"><span class="ex">heroku</span> run npx sequelize-cli db:seed:undo:all</a>
<a class="sourceLine" id="cb6-2" title="2"><span class="ex">heroku</span> run npx sequelize-cli db:migrate:undo:all</a>
<a class="sourceLine" id="cb6-3" title="3"><span class="ex">heroku</span> run npx sequelize-cli db:migrate</a>
<a class="sourceLine" id="cb6-4" title="4"><span class="ex">heroku</span> run npx sequelize-cli db:seed:all</a></code></pre></div>
<p><a href="#-"><img src="https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/colored.png" alt="—————————————————–" /></a></p>
<div data-align="center">
<p>## ➤ Development</p>
