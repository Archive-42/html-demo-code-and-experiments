...
[HTML](https://html.com/)  /  &lt;samp&gt; HTML Tag
...
The `<samp>` element is used to display output from a process, such as an error message from a computer script. It was originally designed for technical documentation, and renders the content of the element in a monospace font. `<samp>` is well supported, and it isn’t deprecated in HTML 5, but there are arguably better ways to achieve the same result. Consider whether [`<code>`](https://html.com/tags/code/) or [`<pre>`](https://html.com/tags/pre/) would be more suitable.
