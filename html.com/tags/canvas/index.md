...
[HTML](https://html.com/)  /  [Every Way Possible To Embed Modern Media With HTML Code](https://html.com/media/) / &lt;canvas&gt; HTML Tag
...
The `<canvas>` element provides a panel of arbitrary size which can be used to display images and other content via [JavaScript](https://html.com/javascript/).
...
[<span class="nav-link-label"><span class="genericon genericon-previous"></span></span>`<bdo> HTML Tag`](https://html.com/tags/bdo/)

[`HTML Code: You Can Use It, But Does Your Browser Support It?`<span class="nav-link-label"><span class="genericon genericon-next"></span></span>](https://html.com/tags/datalist/)
