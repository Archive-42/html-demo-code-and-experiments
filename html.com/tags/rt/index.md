...
[HTML](https://html.com/)  /  &lt;rt&gt; HTML Tag
...
The `<rp>` element is used within the [`<ruby>`](https://html.com/tags/ruby/) element to place parentheses around ruby text.
...
[<span class="nav-link-label"><span class="genericon genericon-previous"></span></span>`<rp> HTML Tag`](https://html.com/tags/rp/)

[`<ruby> HTML Tag`<span class="nav-link-label"><span class="genericon genericon-next"></span></span>](https://html.com/tags/ruby/)
