...
The purpose of `<source>` is to define *multiple* versions of a file, so you can specify different versions for different browsers or platforms. You can use `<source>` within either [`<audio>`](https://html.com/tags/audio/), [`<track>`](https://html.com/tags/track/) or [`<video>`](https://html.com/tags/video/) elements.
