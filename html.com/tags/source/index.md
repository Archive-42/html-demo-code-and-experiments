...
[HTML](https://html.com/)  /  [Every Way Possible To Embed Modern Media With HTML Code](https://html.com/media/) / &lt;source&gt; HTML Tag
...
The purpose of `<source>` is to define _multiple_ versions of a file, so you can specify different versions for different browsers or platforms. You can use `<source>` within either [`<audio>`](https://html.com/tags/audio/), [`<track>`](https://html.com/tags/track/) or [`<video>`](https://html.com/tags/video/) elements.
...
<span class="browser-supported">3.5</span>
...
[<span class="nav-link-label"><span class="genericon genericon-previous"></span></span>`<section> HTML Tag`](https://html.com/tags/section/)

[`<summary> HTML Tag`<span class="nav-link-label"><span class="genericon genericon-next"></span></span>](https://html.com/tags/summary/)
