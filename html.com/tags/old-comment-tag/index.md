...
[HTML](https://html.com/)  /  &lt;comment&gt; HTML Tag
...
<span class="useWarnHead">The Comment Element is Obsolete</span> This element is obsolete and should not be used. Browser support for this element is limited and using it may produce unexpected results. Instead, use the [modern comment tag](https://html.com/tags/comment-tag/).
...
Browsers that do ignore `<comment>` tags will still render any [html](https://html.com/) code nested between the tags. For example:
...
The correct comment tag for HTML is [`<!-- ... -->`](https://html.com/tags/comment-tag/).
...
![](https://html.com/wp-content/plugins/htmlcodetutorial-plugin/assets/images/chrome-false.png)
...
![](https://html.com/wp-content/plugins/htmlcodetutorial-plugin/assets/images/opera-false.png)
