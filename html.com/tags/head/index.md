...
It was once very common to place all JS into the `<head>`, however that is no longer recommended practice because it can slow down page load. Today, the typical recommendation is to place JavaScript at the end of the [`<body>`](https://html.com/tags/body/) element whenever possible.
