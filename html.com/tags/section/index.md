...
[HTML](https://html.com/)  /  [What On Earth Is Semantic Markup? (And Why Should You Learn To Write It)](https://html.com/semantic-markup/) / &lt;section&gt; HTML Tag
...
-   [<span class="toc_number toc_depth_2">0.1</span> Code Example](#Code_Example)

[<span class="toc_number toc_depth_1">1</span> Pink Flamingos](#Pink_Flamingos)

-   [<span class="toc_number toc_depth_2">1.1</span> Presenting Content](#Presenting_Content)
-   [<span class="toc_number toc_depth_2">1.2</span> Browser Support for section](#Browser_Support_for_section)
...
<span id="Pink_Flamingos">Pink Flamingos</span>
===============================================
...
<span id="Presenting_Content">Presenting Content</span>
-------------------------------------------------------

`<section>` is a new HTML 5 element that defines an important section of a document. It can be used within articles, in the header or footer, or to define navigation. If a part of the content deserves its own heading, and that heading would be listed in a theoretical or actual table of contents, it should be placed in a `<section>`. The key exception is where the content may be syndicated; in this case, use [`<article>`](https://html.com/tags/article/) element instead.
...
<span id="Browser_Support_for_section">Browser Support for section</span>
-------------------------------------------------------------------------
...
[<span class="nav-link-label"><span class="genericon genericon-previous"></span></span>`<ruby> HTML Tag`](https://html.com/tags/ruby/)

[`<source> HTML Tag`<span class="nav-link-label"><span class="genericon genericon-next"></span></span>](https://html.com/tags/source/)
