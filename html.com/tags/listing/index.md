...
[HTML](https://html.com/)  /  [Lists Bring Order To Web Pages: Here’s The HTML Code To Create Them](https://html.com/lists/) / &lt;listing&gt; HTML Tag
...
The `<listing>` element was intended as a way to render HTML code on a page. It was never properly supported, and is now deprecated. Using `<listing>` will almost certainly result in unexpected results. Instead, use [`<code>`](https://html.com/tags/code/), or place the content in a `<div>` with the appropriate CSS styling.
