          ...
          948: (e, t, r) => {
            ...
            function z(e) {
                ...
                return (
                  ...
                  p(
                    null !== (v = n.isOpen) && void 0 !== v
                      ? v
                      : u.shouldPanelOpen({ state: c.getState() })
                  ),
                  $(h).then(function () {
              ...
              return (
                ...
                $(
                  u
                    .getSources(
                      M({ query: o, refresh: a, state: c.getState() }, l)
                    )
                    .then(function (e) {
                      return Promise.all(
                        e.map(function (e) {
                          return Promise.resolve(
                            e.getItems(
                              M(
                                { query: o, refresh: a, state: c.getState() },
                                l
                              )
                            )
                          ).then(function (t) {
                    ...
                    ie(
                      {
                        ...
                        onSubmit: function (o) {
                          ...
                          o.preventDefault(),
                            t.onSubmit(
                              ie(
                                { event: o, refresh: r, state: n.getState() },
                                u
                              )
                            ),
              ...
              switch (t.type) {
                ...
                case "blur":
                  return t.props.debug
                    ? e
                    : ge(ge({}, e), {}, { isOpen: !1, activeItemId: null });
                case "mousemove":
                  return ge(ge({}, e), {}, { activeItemId: t.payload });
                case "mouseleave":
                  return ge(
            ...
            function Ce(e) {
              var t = [],
                ...
                n = o(_e, r, function (e) {
                  var t = e.prevState,
                    n = e.state;
                  r.onStateChange(
                    Ae({ prevState: t, state: n, refresh: l }, u)
                  );
                }),
                u = (function (e) {
                  var t = e.store;
              ...
              return (
                ...
                (function (e) {
                  ...
                  metadata: ve({ plugins: r.plugins, options: e }),
            ...
            function Ge(e) {
              var t = e.autocomplete,
                ...
                f = Ue(u),
                d = c.getRootProps(
                  ze({ state: s, props: t.getRootProps({}) }, r)
                ),
                ...
                D = c.getLabelProps(
                  ze({ state: s, props: t.getLabelProps({}) }, r)
                ),
                y = f("button", {
                ...
                b = f("button", {
                  ...
                  children: [we({ environment: u })],
                }),
                _ = f("div", {
                  class: n.loadingIndicator,
                  children: [Se({ environment: u })],
                }),
                O = (function (e) {
                ...
                F = c.getFormProps(
                  ze(
                    { state: s, props: t.getFormProps({ inputElement: O }) },
                    r
                  )
                ),
                P = f("form", ze({ class: n.form, children: [A, C, E] }, F)),
                j = c.getPanelProps(
                  ze({ state: s, props: t.getPanelProps({}) }, r)
                ),
            ...
            function Vt(e) {
              ...
              return function (e) {
                ...
                return t(
                  r,
                  {},
                  ((n = { hit: u, attribute: o }), Wt(xt(n))).map(function (
                    e,
                    r
                  ) {
                    return e.isHighlighted
            ...
            function zt(e) {
              ...
              return function (e) {
                ...
                return t(
                  r,
                  {},
                  ((n = { hit: u, attribute: o }), Wt($t(n))).map(function (
                    e,
                    r
                  ) {
                    return e.isHighlighted
              ...
              function O(e) {
                ...
                !(function (e) {
                  ...
                  Te(
                    n.root,
                    u.getRootProps(
                      lr({ state: o, props: t.getRootProps({}) }, r)
                    )
                  ),
                    Te(
                      n.input,
                    ...
                    if (s.isOpen) {
                      ...
                      var f = s.collections
                        ...
                        d = o(
                          a,
                          null,
                          o("div", { className: u.panelLayout }, f),
                          o("div", { className: "aa-GradientBottom" })
                        ),
